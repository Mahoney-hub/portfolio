...
import projectUnit from '../images/bg-portfolio/project-unit.jpg';
    ...
    return (
        <section className="portfolio" id="portfolio">
            ...
            <div className="box-container">
                ...
                <div className="box">
                    <img src={projectUnit} alt="image"/>
                    <div className="content">
                        <h3>Unit</h3>
                        <p>Technologies: SCSS, JS, Jquery</p>
                        <a href="https://mahoney-hub.github.io/project-unit/" target="_blank">view the
                            project</a>
                    </div>
                </div>
